...
[타임라인 검증 — 연도/시간 논리 체크 (중요)]
- 과거 회상 씬을 쓸 때 반드시 World Bible의 타임라인과 교차 검증
- "N년 전" "N년 차" 같은 시간 표현 사용 시 다른 시간 표현과 충돌 없는지 계산
- 예시 금지: "마부 3년 차" + "17년 전 멸문" = 14년 공백 (이 사이에 뭘 했는지 설명 없으면 모순)
- 캐릭터 나이와 사건 연도도 반드시 일치시킬 것
- 의심 가면 구체적 숫자 대신 "오래전", "어린 시절" 등 모호한 표현 사용
