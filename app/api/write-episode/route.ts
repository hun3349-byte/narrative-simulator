...
## 같은 패턴 반복 금지
- 같은 능력 발현 장면을 2화 연속 쓰지 마
- 능력이 나올 때마다 다른 결과/상황/대가를 보여줘
- 비슷한 전투 패턴 반복 금지 (매번 새로운 변수)

## 설명 대화 금지 (재강조)
- 캐릭터가 설정을 설명하는 대사 절대 금지
  나쁜 예: "이 능력은 상대의 기를 흡수하는 거야."
  좋은 예: 능력을 사용하는 장면에서 상대가 힘이 빠지는 묘사
- "~하는 것이다", "~라고 한다" 류의 설명 대사 금지
- 대신 상황과 결과로 보여줘

## "특별하다" 직접 언급 금지
- 주변 인물이 주인공을 대단하다고 말해주면 안 됨
  나쁜 예: "네 재능은 천재급이야." / "네가 천명이구나."
- 주인공 스스로 깨닫게 해야 함
- 다른 인물의 반응은 대사 대신 행동/표정으로
  좋은 예: 상대가 한 발 물러서며 표정이 굳는다

## 긴장/이완 교차 필수
- 전투/위기 장면 후 반드시 조용한 장면 삽입
- 모닥불, 식사, 걷는 장면, 대화 같은 일상
- 이완이 다음 긴장을 더 강하게 만듦
- 쉼 없이 긴장만 이어지면 독자가 지침

## 클리프행어 유형 다양화 (재강조)
- 직전 화와 같은 클리프행어 유형 절대 금지
- 7가지 유형을 돌려쓸 것:
  위기 직전 / 비밀 폭로 / 선택 강요 / 예상 뒤집기 /
  능력 각성 힌트 / 과거 연결 / 인물 등장

## 주인공 감정 다양화
- 놀람/불안만 반복하지 말 것
- 다양한 감정 활용:
  분노: 이를 깨물었다. 손톱이 손바닥을 파고들었다.
  자조: "역시 나답군." 쓴웃음이 흘렀다.
  호기심: 눈이 반짝였다. 손이 먼저 움직였다.
  외로움: 불빛을 바라보는 눈이 멀어졌다.
  유머: "이게 되네?" 웃음이 터졌다.
- 한 화에 최소 3가지 이상 감정 변화

## 능력 공개 속도 제한
주인공의 능력/정체/비밀은 천천히 공개. "숨기는 양 > 보여주는 양" 철칙.
...
6~10화: 능력 편린. "확실히 뭔가 있다" 수준
  - 하지만 정체는 모름. 본인도 주변도.

11화 이후: 첫 폭주. 대가가 따름.
  - 폭주 후 부작용 필수 (기절, 기억 상실, 아군 피해)
...
## 설명 없이 실행
행동 전 설명 = 긴장 살인. 행동 후 짧은 반응 = 긴장 유지.

  ❌ "이건 ○○ 부적이야. △△ 하는 거지." → 금지
  ✅ 부적이 날아왔다. 무명의 이마에 닿았다. 탔다. 끝.
...
## 진짜 위험 — 대가와 피해
"안전한 전개" 금지. 매 전투에 대가가 있어야 함.

대가 유형:
  - 아군 부상 (가벼운 것도 OK)
  - 주인공 피해 (능력 쓰면 기절/출혈/기억 혼란)
  - 정보 유출 (적이 주인공의 비밀을 알게 됨)
  - 관계 손상 (보호자가 다침 → 죄책감)
  - 시간 손실 (도망 타이밍 놓침)

적이 물러날 때:
  ❌ "이번엔 넘어가주마" (자비로운 적 = 위협 아님)
  ✅ 적이 물러나되 대가를 남김. 귀를 자르고 감 → 진짜 위협

주인공이 이길 때:
  ❌ 깨끗한 승리. 모두 무사.
  ✅ 이겼지만 뭔가를 잃음. 또는 이긴 줄 알았는데 아님.

## 조력자에게 결 주기
"착한 조력자" 금지. 모든 조력자에게 숨은 동기.

  ❌ 그냥 착하게 도와줌. "내가 지켜줄게."
  ✅ 도와주는 이유가 있음:
     - 주인공의 능력을 이용하려는 속내
     - 과거 죄책감 (누군가를 지키지 못한 트라우마)
     - 조직에 보고해야 하는 의무 vs 양심
     - 주인공을 보며 자기 과거가 떠오름

독자가 "왜 도와주는지" 의심하게 만들어야 함.
"이 사람 진짜 아군인가?" 라는 질문.

## 적의 위압감
적이 위협적으로 느껴지려면:

  - 말이 적어야 함 (많이 말하는 적 = 약해 보임)
  - 행동이 잔인해야 함 (경고 없이 실행)
  - 한 번은 이겨야 함 (적이 이기는 장면이 있어야 나중에 무서움)
  - 주인공이 "이 사람은 안 돼" 라고 느끼는 순간

  ❌ "마지막으로 묻겠다. 우리 형제가 어디 갔지?"
  ✅ 부적이 빛났다. 철산의 어깨에서 피가 튀었다. "다음은 목이야."
